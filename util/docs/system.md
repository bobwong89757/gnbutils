...
-   [https://github.com/bobwong89757/lancet/blob/main/system/os.go](https://github.com/bobwong89757/lancet/blob/main/system/os.go)
...
```go
import (
    "github.com/bobwong89757/lancet/v2/system"
)
```
