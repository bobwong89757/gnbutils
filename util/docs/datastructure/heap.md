...
- [https://github.com/bobwong89757/lancet/blob/main/datastructure/heap/maxheap.go](https://github.com/bobwong89757/lancet/blob/main/datastructure/heap/maxheap.go)
...
```go
import (
    heap "github.com/bobwong89757/lancet/v2/datastructure/heap"
)
```
