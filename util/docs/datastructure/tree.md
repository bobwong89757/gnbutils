...
- [https://github.com/bobwong89757/lancet/blob/main/datastructure/tree/bstree.go](https://github.com/bobwong89757/lancet/blob/main/datastructure/tree/bstree.go)
...
```go
import (
    tree "github.com/bobwong89757/lancet/v2/datastructure/tree"
)
```
