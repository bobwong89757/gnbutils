...
- [https://github.com/bobwong89757/lancet/blob/main/datastructure/set/set.go](https://github.com/bobwong89757/lancet/blob/main/datastructure/set/set.go)
...
```go
import (
    set "github.com/bobwong89757/lancet/v2/datastructure/set"
)
```
