...
-   [https://github.com/bobwong89757/lancet/blob/main/random/random.go](https://github.com/bobwong89757/lancet/blob/main/random/random.go)
...
```go
import (
    "github.com/bobwong89757/lancet/v2/random"
)
```
