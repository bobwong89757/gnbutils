...
-   [https://github.com/bobwong89757/lancet/blob/main/fileutil/file.go](https://github.com/bobwong89757/lancet/blob/main/fileutil/file.go)
...
```go
import (
    "github.com/bobwong89757/lancet/v2/fileutil"
)
```
