...
- [https://github.com/bobwong89757/lancet/blob/main/condition/condition.go](https://github.com/bobwong89757/lancet/blob/main/condition/condition.go)
...
```go
import (
    "github.com/bobwong89757/lancet/v2/condition"
)
```
