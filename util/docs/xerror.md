...
-   [https://github.com/bobwong89757/lancet/blob/main/xerror/xerror.go](https://github.com/bobwong89757/lancet/blob/main/xerror/xerror.go)
...
```go
import (
    "github.com/bobwong89757/lancet/v2/xerror"
)
```
