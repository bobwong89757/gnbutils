...
-   [https://github.com/bobwong89757/lancet/blob/main/validator/validator.go](https://github.com/bobwong89757/lancet/blob/main/validator/validator.go)
...
```go
import (
    "github.com/bobwong89757/lancet/v2/validator"
)
```
