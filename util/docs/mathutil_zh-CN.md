...
-   [https://github.com/bobwong89757/lancet/blob/main/mathutil/mathutil.go](https://github.com/bobwong89757/lancet/blob/main/mathutil/mathutil.go)
...
```go
import (
    "github.com/bobwong89757/lancet/v2/mathutil"
)
```
